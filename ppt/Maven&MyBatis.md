  ...
  * 在 `com.itheima` 包下编写 MybatisDemo 测试类
    ...
    public class MyBatisDemo {
        ...
        public static void main(String[] args) throws IOException {
            ...
            InputStream inputStream = Resources.getResourceAsStream(resource);//字符串传进去返回一个字节输入流
            SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build(inputStream);//把流传进去然后通过build 返回一个 sqlSessionFactory 对象
